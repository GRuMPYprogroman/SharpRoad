...
Коллекция мини-проектов на C#, .NET и WPF. Репозиторий собран как набор небольших экспериментов: от TCP-чата и `HttpClient` до аутентификации в ASP.NET Core, Entity Framework, Redis-кэша и генерации PDF.
